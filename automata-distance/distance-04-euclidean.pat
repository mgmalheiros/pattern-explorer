// computation of (approximate) Euclidean distance field from seed cells
...
create sqr_grid 17 17

set cells 143 to 145 chemical S conc 1
...
rule if N conc in 0.03 0.08 change S conc D conc // three to eight neighbor cells
