// computation of Manhattan distance field from seed cells
...
create sqr_grid 16 16

set cells 119 to 120 chemical S conc 1
set cells 135 to 136 chemical S conc 1
...
rule if N conc in 0.02 0.08 change S conc D conc // two to eight neighbor cells
