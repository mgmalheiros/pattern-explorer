// laplacian growth: parameters to explore
...
use chemical G conc 0.1 diff 0.1 // #1 initial concentration and #2 diffusion rate
...
rule if P conc in 0.03 0.04 change P conc +2 // #3 neighbor candidates
...
rule if P conc == 0 change G conc +0.001 // #4 increase in empty space
rule if P conc == 1 change G conc -0.01  // #5 decrease in active cells 
